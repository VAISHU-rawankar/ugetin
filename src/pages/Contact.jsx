...
export default function Contact() {
    ...
    return (
        <div style={{ background: "#000000", minHeight: "100vh", color: "#ffffff", fontFamily: "'DM Sans', sans-serif" }}>
                ...
                <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1.5fr", gap: "60px", alignItems: "start" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                            ...
                            <div style={{ marginTop: "40px", padding: "32px", background: "rgba(255,255,255,0.03)", borderRadius: "24px", border: "1px solid rgba(255,255,255,0.06)" }}>
                                <h4 style={{ fontWeight: 700, marginBottom: "12px" }}>Quick Links</h4>
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                                    {d.quickLinks.map((link, idx) => (
                                        <Link key={idx} to={link.href} style={{ color: "#aaa", textDecoration: "none", fontSize: "0.85rem", display: "flex", alignItems: "center", gap: "8px" }}>
                        ...
                        >
                            <form onSubmit={handleSubmit}>
                                <div style={{ marginBottom: "40px" }}>
                                    <h3 style={{ fontSize: "1.75rem", fontWeight: 700, marginBottom: "8px" }}>{d.form.title}</h3>
                                    <p style={{ color: "#666", fontSize: "0.95rem" }}>{d.form.subtitle}</p>
                                </div>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                                    ...
                                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "20px" }}>
                                        <div>
                                            ...
                                            <select name="inquiry-type" value={formData["inquiry-type"]} onChange={handleChange} style={inputStyle("inquiry-type")}>
                                                <option value="">Select...</option>
                                                {d.form.inquiryTypes.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}
                                            </select>
                                        </div>
                                        <div>
                                    ...
                                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "20px" }}>
                                        ...
                                        <div>
                                            ...
                                            <select name="units" value={formData.units} onChange={handleChange} style={inputStyle("units")}>
                                                <option value="">Select units...</option>
                                                {d.form.unitOptions.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div style={{ 
                                            ...
                                            {d.form.interests.map((item) => (
                                                <label key={item.value} style={{ 
                                                    ...
                                                    cursor: "pointer",
                                                    fontSize: "0.9rem",
                                                    color: formData.interest.includes(item.value) ? "#ffffff" : "#666",
                                    ...
                                    <div>
                                        ...
                                        <select name="demo-preference" value={formData["demo-preference"]} onChange={handleChange} style={inputStyle("demo-preference")}>
                                            <option value="">Select time...</option>
                                            {d.form.demoPreferences.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}
                                        </select>
                                    </div>
