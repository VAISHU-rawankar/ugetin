...
const TestimonialCard = ({ t }) => (
    <div style={{
        ...
        <p style={{ fontSize: "0.85rem", color: "#333", lineHeight: 1.4, flex: 1, fontStyle: "italic", whiteSpace: "normal" }}>
            "{t.text}"
        </p>
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginTop: "5px" }}>
            ...
            />
            <div>
                <div style={{ fontSize: "0.85rem", fontWeight: 700, color: "#000000" }}>{t.name}</div>
